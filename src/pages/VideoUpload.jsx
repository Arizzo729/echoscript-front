...
export default function VideoUpload() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error("Fetch failed:", err);      setStatus("error");
    }
  };
  ...
  return (
    ...
    >      <div className="space-y-8">
        ...
        <form onSubmit={handleSubmit} className="grid gap-6 bg-zinc-900 p-6 rounded-xl border border-zinc-800 shadow-lg">          <label className="flex items-center gap-3 p-4 border border-zinc-700 rounded-lg bg-zinc-800 cursor-pointer hover:bg-zinc-700">
