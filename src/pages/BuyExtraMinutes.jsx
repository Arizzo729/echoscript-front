...
export default function BuyExtraMinutes() {
  ...
  const total = useMemo(() => Object.entries(cart).reduce(
    (acc, [id, qty]) => {
        ...
        <Card className="bg-zinc-900 border border-teal-500 rounded-2xl shadow-xl">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center gap-2 pt-2">
              ...
              <label
                htmlFor="gift"
                className="text-sm text-zinc-300 flex items-center gap-2 cursor-pointer"
              >
            ...
            {gifting && (
              ...
              >
                <input
                  ...
                  className="mt-2 w-full px-4 py-2 rounded-lg bg-zinc-800 border border-zinc-600 text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-teal-500"
                />
              </motion.div>
            )}
            ...
            {Object.keys(cart).length > 0 && (
              <button
                onClick={emptyCart}
                className="mt-3 text-xs text-zinc-400 hover:text-teal-300 underline transition-colors w-full"
              >
                Empty Cart
              </button>
            )}
