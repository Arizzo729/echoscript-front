    ...
    >
      ...
      <div className="rounded-xl border border-zinc-700 shadow-xl bg-zinc-900 p-6 space-y-4 text-white">
        ...
        <button
          ...
          disabled={loading}
          className={`w-full flex justify-center items-center gap-2 py-2 px-4 rounded-lg transition text-white font-semibold bg-${selectedPlan.color} hover:bg-${selectedPlan.color.replace(
            "600",
            "500"
          )}`}
        >
