...
import { Mail, Send, Info, MapPin, ChevronDown, ChevronUp, Phone } from "lucide-react";
      ...
      <div className="mt-16 grid gap-4 text-sm text-zinc-300">
        ...
        <div className="flex flex-col gap-2">
          <button
            ...
            className={`flex items-center gap-2 text-sm font-medium px-3 py-1 rounded-lg border w-fit transition-all duration-200 ${showHours ? "bg-teal-700/10 border-teal-400 text-teal-300" : "border-zinc-600 text-zinc-100 hover:text-teal-200 hover:border-teal-400"}`}
          >
