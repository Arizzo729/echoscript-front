  ...
  return (
    <div className="px-4 py-8 max-w-6xl mx-auto">
      <motion.div
        ...
        className="mb-8"
      >
        <h1 className="text-3xl font-bold text-zinc-800 dark:text-zinc-100 mb-2" data-i18n="transcripts.title">
          {t("transcripts.title", "Your Transcripts")}
        </h1>
        <p className="text-zinc-600 dark:text-zinc-400" data-i18n="transcripts.subtitle">
          {t("transcripts.subtitle", "Browse, view, edit, and manage all your transcriptions")}
        </p>
      </motion.div>
      ...
      <div className="mb-6">
        <div className="relative">
          ...
          <input
            type="text"
            placeholder={t("transcripts.search_placeholder", "Search transcripts...")}
            value={searchQuery}
            ...
            data-i18n="transcripts.search_placeholder"
          />
        </div>
      </div>
      ...
      {loading ? (
        ...
        >
          ...
          <h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-100 mb-2">
            {searchQuery ? t("transcripts.no_matching", "No matching transcripts") : t("transcripts.empty.title", "No Transcripts Yet")}
          </h3>
          <p className="text-zinc-500 dark:text-zinc-400 max-w-md mx-auto">
            {searchQuery 
              ? t("transcripts.adjust_search", "Try adjusting your search query")
            ...
            >
              <div className="flex items-center justify-between p-6 border-b border-zinc-200 dark:border-zinc-700">
                <h2 className="text-2xl font-bold text-zinc-900 dark:text-white">
                  {isEditing ? t("transcripts.edit_title", "Edit Transcript") : t("transcripts.view_title", "View Transcript")}
                </h2>
                <div className="flex gap-2">
                  {!isEditing && (
                    <button
              ...
              <div className="flex-1 overflow-y-auto p-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-2">
                    {t("transcripts.content_label", "Transcript Content")}
                  </label>
                  {isEditing ? (
                    <textarea
                      value={editedContent}
                  ...
                  >
                    {saveLoading ? (
                      <>
                        ...
                        {t("transcripts.saving", "Saving...")}
                      </>
                    ) : (
                      <>
                        <Save className="w-4 h-4" />
                        {t("transcripts.save_changes", "Save Changes")}
                      </>
                    )}
                  </button>
                </div>
