...
/**
 * Minimal audio recorder hook (no external deps).
 * start(): ask mic + start
 * stop(): stop and return File(audio/webm)
 */
function useSimpleRecorder() {
  const mediaRecorderRef = useRef(null);
  const streamRef = useRef(null);
...
>>>>>>> 931584e (fix(hooks): replace useVoiceInput with build-safe hook and switch to .jsx)
