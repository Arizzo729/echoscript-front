...
const tones = [
  { id: "default", label: "Smart", key: "summary.tones.smart" },
  { id: "friendly", label: "Friendly", key: "summary.tones.friendly" },
  { id: "formal", label: "Formal", key: "summary.tones.formal" },
  { id: "bullet", label: "Bulleted", key: "summary.formats.bulleted" },
  { id: "action", label: "Action-Oriented", key: "summary.formats.action_oriented" },
];
  ...
  return (
    ...
    >
      <div className="w-full max-w-2xl bg-zinc-900/95 border border-zinc-800 rounded-3xl shadow-2xl px-3 xs:px-7 py-7 xs:py-10 space-y-7">
        <h1 className="text-2xl xs:text-4xl font-extrabold text-center bg-gradient-to-br from-teal-400 to-blue-500 bg-clip-text text-transparent tracking-tight" data-i18n="summary.title">
          {t("summary.title", "🧠 AI-Powered Summarizer")}
        </h1>

        <p className="text-center text-zinc-400 text-base mb-2" data-i18n="summary.description">
          {t("summary.description", "Paste your transcript below and generate a clear, structured summary with advanced GPT AI.")}
        </p>
        ...
        <Textarea
          ...
          placeholder={t("summary.placeholder", "Paste your transcript here...")}
        ...
        <div className="text-center">
          ...
          >
            {loading ? t("summary.summarizing", "Summarizing...") : t("summary.generate_summary", "Generate Summary")}
          </Button>
        </div>
