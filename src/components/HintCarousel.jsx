...
export default function HintCarousel() {
  ...
  const hints = [
    {
      emoji: "🎙️",
      message: t("hints.mic", "Tap the mic to start live recording — we'll transcribe everything clearly in real time."),
    },
    {
      emoji: "📂",
      message: t("hints.upload", "Upload audio or video files and let EchoScript generate clean, timestamped transcripts."),
    },
    {
      emoji: "✨",
      message: t("hints.summarize", "Turn long conversations into summaries with one click — powered by our smart AI assistant."),
    },
    {
      emoji: "🌐",
      message: t("hints.languages", "Switch between languages easily. We support English, Spanish, and more coming soon!"),
    },
  ];
