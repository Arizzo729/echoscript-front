// âœ… EchoScript.AI â€” Polished Enhanced Toggle with Audio
...
export default function Toggle({
  ...
  const { playClick, isMuted } = useSound(); // âœ… Correct sound function

  const handleToggle = (val) => {
    if (!disableSound && !isMuted) playClick(); // âœ… Proper audio
    onChange(val);
  };
