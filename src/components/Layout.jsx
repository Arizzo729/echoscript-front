// ✅ EchoScript.AI: Layout.jsx — Responsive Header, Sidebar, and Mobile UX
      ...
      <UserContext.Provider value={{ user }}>
        <NotificationContext.Provider value={{ notifications, markAllRead }}>
          <FontSizeContext.Provider value={{ fontSize: clampedFontSize, setFontSize }}>
            <div
              className={`flex h-screen overflow-hidden transition-all duration-300 ease-in-out bg-background-light dark:bg-background-dark text-text-light dark:text-text-dark`}
            ...
            >
              ...
              <div
                className={`flex flex-col flex-grow ${
                  !isMobile ? (sidebarOpen ? "pl-[240px]" : "pl-[64px]") : "pl-0"
                }`}
              >
                <Header
