// ✅ Upgraded Sidebar.jsx — Animated, Responsive, Themed Navigation
...
export default function Sidebar() {
  ...
  return (
    <motion.aside
      ...
      className="h-screen fixed top-0 left-0 z-30 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 shadow-md flex flex-col transition-all"
    >
      {/* Header */}
