...
import illustration1 from "public/assets/onboarding/upload.json";
import illustration2 from "public/assets/onboarding/cleanup.json";
import illustration3 from "public/assets/onboarding/global.json";
import illustration4 from "public/assets/onboarding/security.json";
import illustration5 from "public/assets/onboarding/integrations.json";
import illustration6 from "public/assets/onboarding/start.json";
      ...
      {!dismissed && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={handleClose}
              className="absolute top-4 right-5 text-sm text-zinc-400 hover:text-teal-400 transition duration-200"
            ...
            <div className="mt-6 flex justify-center items-center gap-6 z-10">
              {step > 0 && (
                <button
                  ...
                  className="text-xs px-4 py-1.5 rounded-full bg-gradient-to-br from-teal-600 to-teal-400 text-white font-medium shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300"
                >
                  Back
                </button>
              )}
