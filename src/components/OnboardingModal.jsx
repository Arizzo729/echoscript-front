...
const STEPS = [
  ...
  { title: "Global Support", description: "Echo understands all voices — English, Spanish, Arabic, and more." },
  { title: "Privacy First", description: "End-to-end encryption, CAPTCHA, and 2FA. Your data stays yours." },
  { title: "Seamless Uploads", description: "Use drag-and-drop, Google Drive, or Dropbox — it’s all built in." },
  { title: "Let’s Transcribe", description: "You’re ready. Pick a plan and start exploring EchoScript.AI." },
];
        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              transition={{ duration: 0.3 }}
            >
              <h2 className="text-xl font-medium mb-2">{STEPS[step].title}</h2>
              <p className="text-sm text-zinc-400 max-w-sm mx-auto">{STEPS[step].description}</p>
            </motion.div>
            ...
            <div className="mt-6 flex justify-center items-center gap-4 z-10">
              ...
              <button
                ...
                className="text-xs px-4 py-1.5 rounded-full bg-gradient-to-br from-teal-500 to-blue-500 
                hover:from-blue-500 hover:to-teal-400 text-white font-medium shadow-md 
