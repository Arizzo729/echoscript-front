...
import RecoverDeletedPage from "./pages/RecoverDeletedFiles";
...
function OverlayManager() {
  ...
  return (
    <>
      ...
      {introComplete && (
        <>
          <div className="fixed bottom-24 left-4 right-4 z-[60] max-w-3xl mx-auto pointer-events-auto">
                ...
                <ErrorBoundary>
                  ...
                  <Routes>
                    <Route element={<Layout />}>
                      ...
                      <Route path="/thank-you" element={<ReceiptPage />} />
                      ...
                      <Route path="/recover" element={<RecoverDeletedPage />} />
