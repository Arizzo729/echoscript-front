...
def _ignore_function(filename, function_name):
    return (
        function_name in PYTEST_FUNCTION_NAMES or function_name.startswith("test_")
...
class Vulture(ast.NodeVisitor):
    ...
    def __init__(self, verbose=False, ignore_names=None, ignore_decorators=None):
    ...
    def visit_FunctionDef(self, node):
        decorator_names = [
            utils.get_decorator_name(decorator) for decorator in node.decorator_list
        ]
