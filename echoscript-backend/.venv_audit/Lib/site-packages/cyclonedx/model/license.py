...
class DisjunctiveLicense:
    ...
    def acknowledgement(
        self, acknowledgement: Optional[LicenseAcknowledgement]
    ) -> None:
        self._acknowledgement = acknowledgement
    ...
    def __lt__(self, other: Any) -> bool:
        if isinstance(other, DisjunctiveLicense):
            return _ComparableTuple((self._id, self._name)) < _ComparableTuple(
    ...
    def __hash__(self) -> int:
        return hash(
            (self._id, self._name, self._text, self._url, self._acknowledgement)
        )
...
class LicenseExpression:
    ...
    def __init__(
        self,
        value: str,  # *,  # all optional args are intended to be keyword-args
        acknowledgement: Optional[LicenseAcknowledgement] = None,
    ) -> None:
        self._value = value
        self._acknowledgement = acknowledgement
