...
class DataClassification:
    ...
    def __lt__(self, other: object) -> bool:
        if isinstance(other, DataClassification):
            ...
            ) < _ComparableTuple((other.flow, other.classification))
...
class AttachedText:
    ...
    def __lt__(self, other: Any) -> bool:
        if isinstance(other, AttachedText):
            ...
            ) < _ComparableTuple((other.content_type, other.content, other.encoding))
        return NotImplemented
    ...
    def __repr__(self) -> str:
        return (
            f"<AttachedText content-type={self.content_type}, encoding={self.encoding}>"
        )
...
class HashType:
    ...
    def from_hashlib_alg(hashlib_alg: str, content: str) -> "HashType":
        ...
        if alg is None:
            raise UnknownHashTypeException(
                f"Unable to determine hash alg for {hashlib_alg!r}"
            )
    ...
    def from_composite_str(composite_hash: str) -> "HashType":
        ...
        raise UnknownHashTypeException(
            f"Unable to determine hash type from {composite_hash!r}"
        )
    ...
    def __lt__(self, other: Any) -> bool:
        if isinstance(other, HashType):
            return _ComparableTuple((self.alg, self.content)) < _ComparableTuple(
...
class _ExternalReferenceSerializationHelper(serializable.helpers.BaseHelper):
    ...
    __CASES: Dict[Type[serializable.ViewType], FrozenSet[ExternalReferenceType]] = (
        dict()
    )
    ...
    @classmethod
    def __normalize(
        cls, extref: ExternalReferenceType, view: Type[serializable.ViewType]
    ) -> str:
        return (
            extref
...
class XsUri(serializable.helpers.BaseHelper):
    ...
    _INVALID_URI_REGEX = re.compile(
        r"%(?![0-9A-F]{2})|#.*#", re.IGNORECASE + re.MULTILINE
    )
...
class ExternalReference:
    ...
    def __lt__(self, other: Any) -> bool:
        if isinstance(other, ExternalReference):
            ...
            ) < _ComparableTuple((other._type, other._url, other._comment))
        return NotImplemented
...
class Property:
    ...
    def __lt__(self, other: Any) -> bool:
        if isinstance(other, Property):
            return _ComparableTuple((self.name, self.value)) < _ComparableTuple(
...
class NoteText:
    ...
    def __lt__(self, other: Any) -> bool:
        if isinstance(other, NoteText):
            ...
            ) < _ComparableTuple((other.content, other.content_type, other.encoding))
        return NotImplemented
...
class Note:
    ...
    def __lt__(self, other: Any) -> bool:
        if isinstance(other, Note):
            return _ComparableTuple((self.locale, self.text)) < _ComparableTuple(
...
class Tool:
    ...
    def external_references(
        self, external_references: Iterable[ExternalReference]
    ) -> None:
    ...
    def __lt__(self, other: Any) -> bool:
        if isinstance(other, Tool):
            ...
            ) < _ComparableTuple((other.vendor, other.name, other.version))
        return NotImplemented
...
class IdentifiableAction:
    ...
    def __lt__(self, other: Any) -> bool:
        if isinstance(other, IdentifiableAction):
            ...
            ) < _ComparableTuple((other.timestamp, other.name, other.email))
        return NotImplemented
