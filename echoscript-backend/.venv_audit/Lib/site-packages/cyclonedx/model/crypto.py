...
class AlgorithmProperties:
    ...
    def nist_quantum_security_level(
        self, nist_quantum_security_level: Optional[int]
    ) -> None:
    ...
    def __hash__(self) -> int:
        return hash(
            (
                ...
                tuple(self.certification_levels),
                self.mode,
                self.padding,
                tuple(self.crypto_functions),
...
class CertificateProperties:
    ...
    def signature_algorithm_ref(
        self, signature_algorithm_ref: Optional[BomRef]
    ) -> None:
    ...
    def __lt__(self, other: Any) -> bool:
        if isinstance(other, ProtocolPropertiesCipherSuite):
            return _ComparableTuple(
                (
                    self.name,
                    _ComparableTuple(self.algorithms),
                    _ComparableTuple(self.identifiers),
                )
            ) < _ComparableTuple(
                (
                    other.name,
                    _ComparableTuple(other.algorithms),
                    _ComparableTuple(other.identifiers),
                )
            )
...
class ProtocolProperties:
    ...
    @property
    @serializable.xml_array(
        serializable.XmlArraySerializationType.NESTED, "cipherSuite"
    )
    @serializable.xml_sequence(30)
    ...
    def cipher_suites(
        self, cipher_suites: Iterable[ProtocolPropertiesCipherSuite]
    ) -> None:
    ...
    def ikev2_transform_types(
        self, ikev2_transform_types: Optional[Ikev2TransformTypes]
    ) -> None:
...
class CryptoProperties:
    ...
    def __init__(
        ...
        *,
        ...
        related_crypto_material_properties: Optional[
    ...
    def algorithm_properties(
        self, algorithm_properties: Optional[AlgorithmProperties]
    ) -> None:
    ...
    def protocol_properties(
        self, protocol_properties: Optional[ProtocolProperties]
    ) -> None:
