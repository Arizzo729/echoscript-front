...
from ..schema._res import BOM_JSON as _S_BOM
from ..schema._res import BOM_JSON_STRICT as _S_BOM_STRICT
from ..schema._res import JSF as _S_JSF
from ..schema._res import SPDX_JSON as _S_SPDX
from . import BaseSchemabasedValidator, SchemabasedValidator, ValidationError

_missing_deps_error: Optional[
    Tuple[MissingOptionalDependencyException, ImportError]
] = None
try:
    from jsonschema.exceptions import (
        ValidationError as JsonValidationError,  # type:ignore[import-untyped]
    )
    ...
    if TYPE_CHECKING:  # pragma: no cover
        from jsonschema.protocols import (
            Validator as JsonSchemaValidator,  # type:ignore[import-untyped]
        )
...
class JsonStrictValidator(
    _BaseJsonValidator, BaseSchemabasedValidator, SchemabasedValidator
):
