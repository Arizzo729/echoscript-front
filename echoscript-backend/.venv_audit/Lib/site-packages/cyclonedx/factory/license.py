...
from ..spdx import fixup_id as spdx_fixup
from ..spdx import is_compound_expression as is_spdx_compound_expression
...
class LicenseFactory:
    ...
    def make_from_string(
        ...
        *,
        ...
        try:
            ...
            pass
        try:
            return self.make_with_expression(
                value, acknowledgement=license_acknowledgement
            )
    ...
    def make_with_name(
        ...
        *,
        ...
        return DisjunctiveLicense(
            name=name, text=text, url=url, acknowledgement=acknowledgement
        )
